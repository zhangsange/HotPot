...
public class ImageFetcher extends ImageResizer {
	...
	private void init(Context context) {
		...
		mHttpCacheDir = ImageCache.getDiskCacheDir(context,
				Globle.IMAGE_DOWNLOAD_DIR);
	}
	...
	private void checkConnection(Context context) {
		...
		if (networkInfo == null || !networkInfo.isConnectedOrConnecting()) {
			// Toast.makeText(context, "娌℃�缃��杩��,璇锋��ユ����缁�,
	...
	private Bitmap processBitmap(String data) {
		...
		if (fileDescriptor != null) {
			try {
				...
				clearMemoryInternal();
				Logger.e(TAG, "processBitmap OutOfMemoryError -" + e);
			}
		}
	...
	public boolean downloadUrlToStream(String urlString,
		...
		try {
			...
			String imageUrl = urlString;
			int point = urlString.indexOf("?");
			if (point != 0 && point != -1)
				imageUrl = urlString.substring(0, point);
